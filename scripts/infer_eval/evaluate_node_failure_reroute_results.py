...
DEFAULT_RESULT_PATH = Path("vllm-results/node_failure_reroute")
DEFAULT_OUTPUT_DIR = Path("vllm-results/node_failure_reroute-evaluation")
...
def parse_args() -> argparse.Namespace:
    ...
    add_evaluation_arguments(
        ...
        default_project="topology-node-failure-reroute",
        default_experiment="node-failure-reroute-evaluation",
    )
