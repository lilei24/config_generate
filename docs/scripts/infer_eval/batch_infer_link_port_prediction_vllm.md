# batch_infer_link_port_prediction_vllm.py

> 代码位置：[`scripts/infer_eval/batch_infer_link_port_prediction_vllm.py`](../../../scripts/infer_eval/batch_infer_link_port_prediction_vllm.py)
...
| `--output-root OUTPUT_ROOT` | 推理结果根目录，默认: vllm-results/link_port_prediction |
...
```bash
python scripts/infer_eval/batch_infer_link_port_prediction_vllm.py --help
```
