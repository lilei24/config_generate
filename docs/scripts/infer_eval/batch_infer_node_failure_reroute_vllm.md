# batch_infer_node_failure_reroute_vllm.py

> 代码位置：[`scripts/infer_eval/batch_infer_node_failure_reroute_vllm.py`](../../../scripts/infer_eval/batch_infer_node_failure_reroute_vllm.py)
...
| `--output-root OUTPUT_ROOT` | 推理结果根目录，默认: vllm-results/node_failure_reroute |
...
```bash
python scripts/infer_eval/batch_infer_node_failure_reroute_vllm.py --help
```
