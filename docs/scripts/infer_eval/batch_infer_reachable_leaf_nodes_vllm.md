# batch_infer_reachable_leaf_nodes_vllm.py

> 代码位置：[`scripts/infer_eval/batch_infer_reachable_leaf_nodes_vllm.py`](../../../scripts/infer_eval/batch_infer_reachable_leaf_nodes_vllm.py)
...
| `--output-root OUTPUT_ROOT` | 推理结果根目录，默认: vllm-results/reachable_leaf_nodes |
...
```bash
python scripts/infer_eval/batch_infer_reachable_leaf_nodes_vllm.py --help
```
