# batch_infer_node_failure_ap_impact_vllm.py

> 代码位置：[`scripts/infer_eval/batch_infer_node_failure_ap_impact_vllm.py`](../../../scripts/infer_eval/batch_infer_node_failure_ap_impact_vllm.py)
...
| `--output-root OUTPUT_ROOT` | 推理结果根目录，默认: vllm-results/node_failure_ap_impact |
...
```bash
python scripts/infer_eval/batch_infer_node_failure_ap_impact_vllm.py --help
```
