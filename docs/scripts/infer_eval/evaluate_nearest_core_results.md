# evaluate_nearest_core_results.py

> 代码位置：[`scripts/infer_eval/evaluate_nearest_core_results.py`](../../../scripts/infer_eval/evaluate_nearest_core_results.py)
...
```bash
python scripts/infer_eval/evaluate_nearest_core_results.py --help
```
