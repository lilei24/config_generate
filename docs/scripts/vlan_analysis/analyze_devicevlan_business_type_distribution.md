# analyze_devicevlan_business_type_distribution.py

> 代码位置：[`scripts/vlan_analysis/analyze_devicevlan_business_type_distribution.py`](../../../scripts/vlan_analysis/analyze_devicevlan_business_type_distribution.py)
...
| `-o OUTPUT_DIR, --output-dir OUTPUT_DIR` | 结果输出目录，默认: /tmp/devicevlan_business_type_analysis |
...
| `DEFAULT_OUTPUT_DIR` | `'/tmp/devicevlan_business_type_analysis'` |
| `DEFAULT_SPLIT` | `'all'` |
...
```bash
python scripts/vlan_analysis/analyze_devicevlan_business_type_distribution.py --help
```
...
| `device_type (function)` | 核心内部接口 |
| `find_target_keys (function)` | 返回节点出现的目标字段集合及 devicevlan-business 对象数量。 |
| `analyze_graph (function)` | 核心内部接口 |
| `update_distributions (function)` | 核心内部接口 |
| `ordered_counts (function)` | 核心内部接口 |
| `distribution_summary (function)` | 核心内部接口 |
| `distribution_rows (function)` | 核心内部接口 |
